...
const Newsletter = () => {
  return (
    <div className="bg-primary-red padding-x padding-y w-full">
      <div className="flex md:flex-row flex-col items-center justify-between lg:gap-[220px] gap-[40px] bg-white dark:bg-slate-800 lg:p-20 md:p-8 p-4 max-width transition-colors duration-200">
        <div className="flex flex-col md:items-start items-center md:gap-6 gap-4 md:w-[600px] w-full">
          ...
          <p className="text-black dark:text-slate-200 md:text-left text-center font-bold text-[1rem] leading-[22px] lg:w-[350px] md:w-[250px] w-full">
        ...
        <div className="flex flex-col items-start gap-3 lg:max-w-[400px] max-w-[320px]">
          <label className="text-black dark:text-slate-100 text-[1.4rem] font-semibold">
          ...
          />
          <p className="text-black dark:text-slate-300 font-semibold text-[0.9rem] font-left ">
