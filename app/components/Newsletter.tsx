...
const Newsletter = () => {
  return (
    <div className="bg-primary-red padding-x padding-y w-full">
      <div className="flex items-center justify-between gap-20 bg-white p-20 max-width">
        <div className="flex flex-col items-start gap-6 w-[600px]">
          <h3 className="text-primary-red text-[1.4rem] font-semibold w-fit">
            Get inspired by KetoHub's superstar recipes.
          </h3>
          <p className="text-black font-semibold text-[1rem] leading-[22px] w-[600px]">
